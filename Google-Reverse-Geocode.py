...
def get_google_results(address, api_key='XXXXXXX', return_full_response=False):
    """
    ...
    # Set up your REVERSE-Geocoding url
...
test_result = get_google_results("40.752726, -73.977229", API_KEY, RETURN_FULL_RESULTS)
if (test_result['status'] != 'OK') or (test_result['formatted_address'] != '89 E 42nd St, New York, NY 10017, USA'):
